...
def index():
   ...
   if search_news:
       ...
       return render_template('index.html', title = title, general = general_news, entertainment = entertainment_news,health = health_news,sports = sports_news,science = science_news,technology = technology_news,business = business_news )
